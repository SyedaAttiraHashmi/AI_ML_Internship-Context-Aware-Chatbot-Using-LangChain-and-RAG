...
Project Structure Task4_Chatbot/ │── app.py # Streamlit app for the chat UI │── main.py # Code to initialize LLM, chain, and vector store │── data/ # Folder containing PDF documents │── .env # API key for Groq model │── README.md
